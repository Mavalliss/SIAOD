"""
Django settings for SIAOD1 project.
...
SECRET_KEY = 'ul#^_6gt1-@rr(vio_!zvx2ywx5=x612rytzyj^ld1&d6cd3$)'
...
WSGI_APPLICATION = 'SIAOD1.wsgi.application'
